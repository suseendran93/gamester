    ...
    render(){
        return(
            <div className="gameInfo">
                {this.props.sendPram}
        <div id="close" class="close-content displayNone">
        <button  type="button" onclick="hideInfo()">X</button>
        </div>
        <div id="RPG" class="gameCategory displayNone">
        ...
        <div id="FPS" class="gameCategory displayNone">
            <h2>First person shooting</h2>
        </div>
        <div id="Racing" class="gameCategory displayNone">
            <h2>Racing</h2>
        </div>
        <div id="Free to play" class="gameCategory displayNone">
            <h2>Free to play</h2>
        </div>
        </div>
        );
