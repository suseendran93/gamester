    ...
    render(){
        return(
            <div className="gameInfo">
                {this.props.sendPram}
        <div id="close" className="displayNone">
        <button  type="button">X</button>
        </div>

        {this.props.sendPram === "RPG" &&
        (<div id="RPG" className="gameCategory">
        ...
        || this.props.sendPram === "FPS" &&

        (<div id="FPS" className="gameCategory">
        <h2>First person shooting</h2>
        </div>)

        || this.props.sendPram === "Racing" &&
    
        (<div id="Racing" className="gameCategory">
        <h2>Racing</h2>
        </div>)

        || this.props.sendPram === "Free to play" &&
        
        (<div id="Free to play" className="gameCategory">
        <h2>Free to play</h2>
        </div> )   
